...
const loginSchema = z.object({
  code: z.string().min(6, 'Mã số phải có ít nhất 6 ký tự'),
        ...
        >
          ...
          >
            ...
            <Typography variant="body2" color="text.secondary" mb={4}>
              Nhập thông tin đăng nhập sinh viên để tiếp tục
            </Typography>
          </motion.div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <Controller
                ...
                render={({ field }) => (
                  ...
                  >
                    <InputLabel htmlFor="student-password">Mật khẩu</InputLabel>
                    <OutlinedInput
                      {...field}
                      id="student-password"
